...
const HeroLeftSection = () => {
  ...
  return (
    <div className="w-full h-[50vh] mt-25 px-8 flex flex-col justify-center lg:gap-2 gap-3">
      ...
      <h1 className="lg:text-7xl text-6xl font-extrabold tracking-tight font-Outfit text-transparent bg-clip-text bg-linear-to-t from-teal-950 to-teal-200 animate-typing">
        KanzulEman
      </h1>
      <div className="absolute lg:top-87 md:top-80 lg:left-90 md:left-74 left-63 top-73 animate-float-slow opacity-80 text-yellow-500">
      ...
      <div>
        {" "}
        <p className="lg:text-xl text-[20px] font-Outfit font-bold  md:text-2xl text-purple-500">
      ...
      <div>
        <p className="font-Inter lg:text-1.5xl text-[14px] text-white text-justify pr-10">
          ...
          interface, delivering clean code, optimized performance, and scalable
