...
export default function Navbar() {
  return (
    <div className=" fixed top-7 w-full flex items-center justify-center z-100">
      <div className="w-[90%] md:w-2/3 lg:w-1/3 h-15 rounded-full bg-linear-to-r from-purple-600 to-purple-800  px-7 py-4 transition-all duration-500 animate-float-breath">
